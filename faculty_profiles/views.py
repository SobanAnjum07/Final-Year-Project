...
def faculty_directory(request):
    # Get all faculty profiles that have uploaded content
    faculty_with_content = FacultyProfile.objects.filter(subjects__lecturecontent__isnull=False).distinct()
    
    return render(request, "faculty_profiles/faculty_directory.html", {
        "faculty_list": faculty_with_content,
    })
...
def faculty_detail(request, faculty_id):
    ...
    return render(request, "faculty_profiles/faculty_detail.html", {
        "faculty": faculty,
        "lectures_by_subject": lectures_by_subject,
    })